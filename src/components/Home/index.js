...
// Import actions :
import { actionCountPro, actionSetScrollValue } from '../../actions/appLvl';
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    //   // console.log(document.body.scrollHeight, window.clientHeight);
  ...
  return (
    <div className="home">
      ...
      {/* <h1 className="home__title">Présentation du concept</h1> */}
      ...
      {/* <p className="home__container--text home__container--text--inline">
